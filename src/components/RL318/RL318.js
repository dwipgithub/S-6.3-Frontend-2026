...
import RL318SatuSehat from "./RL318SatuSehat";
    ...
    try {
      ...
      const total_rawat_jalan = rlTigaTitikDelapanBelasDetails.reduce(
        (previousValue, currentValue) => {
          return previousValue + (currentValue.rawat_jalan || 0);
        },
        0,
      );
      ...
      const total_igd = rlTigaTitikDelapanBelasDetails.reduce(
        (previousValue, currentValue) => {
          return previousValue + (currentValue.igd || 0);
        },
        0,
      );
      ...
      const total_rawat_inap = rlTigaTitikDelapanBelasDetails.reduce(
        (previousValue, currentValue) => {
          return previousValue + (currentValue.rawat_inap || 0);
        },
        0,
      );
    ...
    >
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <Tabs defaultActiveKey="sirs" id="rl318-main-tabs" className="mb-3">
            <Tab eventKey="sirs" title="SIRS">
                ...
                <div className={`tab-content ${style.tabContent}`}>
                  ...
                  >
                    <div className={style.validasiCard}>
                      <h3 className={style.validasiCardTitle}>
                        Validasi RL 3.18
                      </h3>
                      {!isFilterApplied ? (
                        <div
                        ...
                        >
                          <strong>
                            Silakan pilih filter terlebih dahulu untuk
                            menampilkan data.
                          </strong>
                        </div>
                      ) : idValidasi ? (
            ...
            <Tab eventKey="satusehat" title="SATUSEHAT">
              <RL318SatuSehat />
            </Tab>
          </Tabs>
        </div>
