...
import RL311SatuSehat from "./RL311SatuSehat";
    ...
    try {
      ...
      if (idValidasi != "") {
        await axiosJWT.patch(
          "/apisirs6v2/rltigatitiksebelasvalidasi/" + idValidasi,
          {
            statusValidasiId:
    ...
    >
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <Tabs defaultActiveKey="sirs" id="rl317-main-tabs" className="mb-3">
