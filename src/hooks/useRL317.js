...
import {
  getRL317DataSatuSehat,
  syncRL317DataSatuSehat,
} from "../services/rl317.services";
import { useCSRFTokenContext } from "../components/Context/CSRFTokenContext";
import { useAuthAxios } from "./useAuthAxios";

export const useRL317 = (axiosJWT, token, CSRFToken, currentUser) => {
  ...
  const fetchData = useCallback(
    async (
      ...
      try {
        const res = await getRL317DataSatuSehat({
          axiosJWT,
...
export const useRL317Bootstrap = () => {
